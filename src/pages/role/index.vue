<template>
    <div>
        ...
        label="角色排序"
        width="120">
        <template slot-scope="scope">{{ scope.row.roleorder }}</template>
        </el-table-column>
        <el-table-column
        label="权限">
        <template slot-scope="scope">
            <el-tag type="success" v-for="(item, key) in scope.row.allowpathname" :key="key" style="margin-left:5px;">{{item}}</el-tag>
        </template>
        </el-table-column>
        </el-table>
        <div class="block">
